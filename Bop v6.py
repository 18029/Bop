...
#States for checking what to display
start_game = False
menu_screen = False
play_game = False
end_screen = False
...
unravel_button = Word_Button(390, 100, "Unravel")
rick_button = Word_Button(390, 150, "Rick")
...
while running:
    ...
    #This shows that no inputs have been detected and will show the starting menu            
    ...
    #Shows menu
        ...
        if unravel_button.draw_wbutton():
            ...
            print(start_game, play_game, end_screen)
                 
          
    
        elif rick_button.draw_wbutton():
            print("yo")
