...
class Note_timing:
    ...
    def get_y(self):
        ...
        for i in range(len(self.timing)):
            ...
            self.song.append(-(self.timing[i]-0.15)*(song_speed*60)+516)
...
for i in range(len(darrowY)):
    arrow_group.add(Arrow("darrow", (420), darrowY[i], 0, 4))
...
for i in range(len(uarrowY)):
    arrow_group.add(Arrow("uarrow", (350), uarrowY[i], 0, 4))
...
def display_score(x ,y):
    score = test_font.render("Score : " + str(score_value),False,(64,64,64))
