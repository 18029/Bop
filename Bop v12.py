...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_ESCAPE and play_game == False and over_screen == True:
                rarrow_group.empty()
                larrow_group.empty()
                uarrow_group.empty()
                darrow_group.empty()                
    ...
    if start_game == False and play_game == False and end_screen == False and paused_screen == False:
    ...
    elif highscore_screen == True and menu_screen == False:
        screen.blit(menu_bg, (0, 0))
        display_highscore()
    ...
    elif play_game == False and end_screen == False and menu_screen == False and over_screen == True:
        screen.blit(start_bg, (0, 0))
